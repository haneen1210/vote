...
const router = Router();
router.get('/AllVotesParticipateIn',auth(Object.values(roles)),asynHandler(candidateservices.getspecificCandidateinvotes));
router.get('/getCandidatePosts',auth(Object.values(roles)),asynHandler(candidateservices.getCandidatePosts));
