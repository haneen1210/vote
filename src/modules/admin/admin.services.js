  ...
  try {
    ...
    for (const row of users) {
      ...
      try {
        ...
        if (await userModel.findOne({ phone })) {
          failedRows.push({ row, reason: "phone already exists" });
          continue; // Skip to the next row
        }
        if (await userModel.findOne({ cardnumber })) {
          failedRows.push({ row, reason: "cardnumber already exists" });
          continue; // Skip to the next row
        }
        ...
        <body>
          ...
          <![endif]-->
            <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" role="none" style="padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#FAFAFA">
              <tr>
                <td valign="top" style="padding:0;Margin:0">
                  <table cellpadding="0" cellspacing="0" class="es-content" align="center" role="none" style="border-spacing:0px;width:100%">
                    <tr>
                      <td class="es-info-area" align="center" style="padding:0;Margin:0">
                        <table class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="background-color:transparent;width:600px" bgcolor="#FFFFFF" role="none">
                          <tr>
                            <td align="left" style="padding:20px;Margin:0">
                              <table cellpadding="0" cellspacing="0" width="100%" role="none" style="border-spacing:0px">
                                <tr>
                                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="border-spacing:0px">
                                      <tr>
                                        <td align="center" class="es-infoblock" style="padding:0;Margin:0;line-height:14px;font-size:12px;color:#CCCCCC"><p style="line-height:14px;color:#CCCCCC;font-size:12px"></p></td>
                                      </tr>
                                    </table></td>
                                </tr>
                              </table></td>
        ...
        console.error(`Error adding candidate: ${userName}, Error:`, error);
        failedRows.push({ row, reason: "Error adding candidate" });
      }
    }
    ...
    return res
      .status(500)
      .json({ message: "Error while uploading candidates", error: error.message });
  }
};
