...
router.get('/getdeletAdmin', auth((endPoint.getdelet)), asynHandler(Adminservices.getdeleteuser));
router.get('/getdeletuser', auth((endPoint.getdelet)), asynHandler(Adminservices.getdeleteCandidate));
router.get('/getdeletcandidate', auth((endPoint.SuperAdmin)), asynHandler(Adminservices.getdeleteAdmin));
