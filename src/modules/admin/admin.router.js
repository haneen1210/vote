...
router.get('/getdeletAdmin', auth((endPoint.getdelet)), asynHandler(Adminservices.getdeleteAdmin));
router.get('/getdeletuser', auth((endPoint.getdelet)), asynHandler(Adminservices.getdeleteuser));
router.get('/getdeletcandidate', auth((endPoint.SuperAdmin)), asynHandler(Adminservices.getdeleteCandidate));
