...
router.put('/updateProfile', auth(Object.values(roles)), fileUpload(fileValidation.image).single('image'),validation(validators.UpdateAdminSchema), asynHandler(Adminservices.updateProfile));
